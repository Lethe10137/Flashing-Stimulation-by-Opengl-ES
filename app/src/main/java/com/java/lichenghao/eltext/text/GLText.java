package com.java.lichenghao.eltext.text;
...
import com.java.lichenghao.eltext.text.BatchTextProgram;
import com.java.lichenghao.eltext.text.Program;
public class GLText
{
    ...
    public final static int CHAR_BATCH_SIZE = 1;     // Number of Characters to Render Per Batch
